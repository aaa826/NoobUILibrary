...
local Window = UI:Create("GUIName", "GameName") --change GUIName to your hub name and GameName to whatever game u want it to be
local Page = Win:Page("PageName", true) --set to false if its your 2nd page)
